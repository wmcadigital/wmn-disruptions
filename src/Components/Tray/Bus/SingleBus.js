    ...
    bus: [
      {
        ...
        servicesAffected: {
          ...
          disruptionDescription:
            '<strong>Wednesday 23rd October</strong><br /><strong>09.30 - 15.30&nbsp;</strong><br /><br />Ivyhouse Lane             will be closed at the junction of Birmingham New Road for resurfacing works.<br /><br /> <strong>NXWM Wolverhampton 81</strong>',
    ...
    return (
      ...
      <div>
        {this.state.bus.map(bus => (
          <div key={bus.id}>
            <em>{bus.disruptionStart}</em>
            <br />
            <em>Service Number:{bus.serviceNumber}</em>
            <br />
            <em>{bus.direction}</em>
            <br />
            <em>{bus.routeDesc}</em>
            <br />
            <em>{bus.operatorCode}</em>
            <br />
          </div>
        ))}
      </div>
