...
import { AutoCompleteProvider, ModeProvider, WhenProvider, TrayLayoutProvider } from '.';
...
const ContextProvider = props => {
  ...
  return (
    <ProviderComposer contexts={[<WhenProvider />, <ModeProvider />, <AutoCompleteProvider />, <TrayLayoutProvider />]}>
      {children}
    </ProviderComposer>
  );
};
